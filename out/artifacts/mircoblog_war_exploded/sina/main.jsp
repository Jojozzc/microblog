		...
		<div class="col-md-7">
			<div class="fu-bu">
				...
				<div class="juli">
					...
					<span></span>
					<input id="myFa" class="btn btn-warning" type="button" value="发布" disabled="disabled">
			...
			<div class="remen">
				...
				<ul>
					<li><span class="zhuan"></span></li>
					<li><span class="ping"></span></li>
...
<%--<html>--%>
	...
	<%--<body>--%>
			...
			<%----%>
				<%--<div class="he2">--%>
					<%--<ul>--%>
						<%--<li><a href="#"><img src="img/Register-img/yonghu.png" alt="" style="vertical-align: text-top"/>&nbsp;&nbsp;<span>${user}</span></a></li>--%>
					<%--</ul>--%>
				<%--</div>--%>
					<%--<div class="he1">--%>
					<%--<ul>--%>
						<%--<li><img src="img/Register-img/发现 (2).png" alt="" />&nbsp;&nbsp;<a href="javascript:void(0)">发现</a></li>--%>
						<%--<li><img src="img/Register-img/游戏.png" alt="" />&nbsp;&nbsp;<a href="#">游戏</a></li>--%>
						<%--<li><img src="img/Register-img/视频.png" alt="" />&nbsp;&nbsp;<a href="#">视频</a></li>--%>
						<%--<li><img src="img/Register-img/首页 (1).png" alt="" />&nbsp;&nbsp;<a href="#">首页</a></li>--%>
					<%--</ul>--%>
				<%--</div>--%>
			<%--</div>--%>
		<%--</header>--%>
		...
		<%--<div class="container">--%>
			<%--<div class="row">--%>
				<%--<div class="col-md-2">--%>
					...
					<%--</ul>--%>
					<%--<ul class="side-sec">--%>
						<%--<li class="sec">关注列表&nbsp;&nbsp;&nbsp;&nbsp;<span id="xiaLa">></span></li>--%>
					<%--</ul>--%>
				<%--</div>--%>
				<%--<div class="col-md-7">--%>
					<%--<div class="fu-bu">--%>
